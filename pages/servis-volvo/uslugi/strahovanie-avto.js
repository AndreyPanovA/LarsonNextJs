      ...
      <TextBlack url={urlText}>
        <div class="text__block">
          <div class="little__text">
            <h1>Insurance</h1>
            <p>
              «Larson» сотрудничает с крупнейшей универсальной страховой
              компанией «РЕСО». Для наших Клиентов предусмотрен весь перечень
              страхования, в том числе страхование домов и квартир, выездов за
              рубеж, корпоративное страхование и др.
            </p>
          </div>
          <p>
